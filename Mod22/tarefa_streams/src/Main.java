...
public class Main {
    public static void main(String[] args) {
        ...
        // Divide a entrada por vírgula e armazena em uma lista
        List<String> itens = Arrays.asList(input.split(","));
        
        // Converte a lista de strings para objetos Pessoa
        ...
        // Utiliza lambdas e streams para filtrar apenas as mulheres
        List<Pessoa> mulheres = pessoas.stream()
                .filter(p -> p.getSexo().equalsIgnoreCase("F"))
                .collect(Collectors.toList());

        // Imprime somente os nomes das mulheres
